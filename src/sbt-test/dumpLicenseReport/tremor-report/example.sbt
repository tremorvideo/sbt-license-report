...
libraryDependencies += "org.asynchttpclient" % "netty-resolver-dns" % "2.0.15"
...
TaskKey[Unit]("check") := {
  ...
  if (!contents.contains("com.fasterxml.jackson.core:jackson-core | 2.5.4 | The Apache Software License, Version 2.0 | http://www.apache.org/licenses/LICENSE-2.0.txt"))
  ...
  if (!contents.contains("junit:junit | 4.12 | Eclipse Public License 1.0 | http://www.eclipse.org/legal/epl-v10.html"))
